...
class MaxConnect4Game:
    ...
    def aiPlay(self, game_mode, depth ):
    ...
    def utility(self):
        #if self.currentTurn == 1:
        #    utility = self.player1Score * 2 - self.player2Score
        #elif self.currentTurn == 2:
        #    utility = self.player2Score * 2 - self.player1Score
